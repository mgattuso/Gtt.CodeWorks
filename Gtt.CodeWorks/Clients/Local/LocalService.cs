...
//{
//    public class LocalService<T> : ILocalService<T> where T : IServiceInstance
//    {
//        private readonly T _serviceInstance;

//        public LocalService(T serviceInstance)
//        {
...
//            request.ServiceHop = (callingService.ServiceHop ?? 0)+1;
