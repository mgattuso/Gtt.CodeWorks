...
namespace Gtt.CodeWorks.Tests.Serializers.JsonNetSerializers
{
    ...
    public class HttpJsonDataSerializerTests
    {
        ...
        {
            // ARRANGE
            var logger = Mock.Of<ILogger<HttpJsonNetDataSerializer>>();
            var serializer = new HttpJsonNetDataSerializer(logger);
